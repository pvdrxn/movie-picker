...
function getTmdbApiKey() {
  // In Expo, prefer EXPO_PUBLIC_ vars (safe for client-side).
  // Fallbacks are here for flexibility across setups.
  return (
...
export async function fetchTrendingMovies({ timeWindow = "week", page = 1 } = {}) {
  // timeWindow: "day" | "week"
